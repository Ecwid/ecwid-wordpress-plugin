...
== Changelog ==
= 7.0 - Mar 26, 2025 =
- **New clean and SEO friendly URL format for your product and category pages with no odd numbers!** We have released a new format for links to product and category pages. It allows you to remove automatically generated numbers from product and category URL slugs for better SEO, such as changing `shoes-c123` to `shoes`. To enable this format, go to `WordPress admin > Ecwid > Storefront`, scroll down and find the "Set URL slugs without IDs for products and categories" option.
- What's more, if you're on a Business or Unlimited plan, you can specify custom slugs (URL endings) for products and categories to make them even nicer and more SEO-friendly.
...
= 6.12.25 - Jan 16, 2025 =
- Improved display of storefront element animation.
- High resource consumption caused by inefficient queries has been fixed.
- Internal improvements and optimizations.

...
= 6.9.8 - Jun 08, 2020 =
- **Added 2 ecommerce widgets in the Elementor page builder.** The Ecwid plugin now provides 2 ecommerce blocks for Elementor for adding online store functionality to your site pages. It allows you to add a storefront to your ecommerce website pages easier in Elementor. The widgets include: the store home page to display the whole storefront, the buy now button to add buttons to blog posts. To try the new widgets, open the Elementor editor in your WordPress admin backend and find the "Ecwid Store" widgets set there.

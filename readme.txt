...
== Changelog == 
= 6.9.2 - Apr 06, 2020 =
- **Integration with the RankMath SEO plugin.** The “RankMath” plugin is a tool to set SEO meta tags on site pages and to generate a sitemaps. Previously it rewrote the SEO tags that Ecwid generated for search engines on your ecommerce site for products and categories pages. And the sitemaps generated by RankMath plugin did not include links to storefront's pages. It’s now fixed so if you use the plugin, everything should work fine and Google will index your products pages properly.

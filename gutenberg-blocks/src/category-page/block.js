...
registerBlockType('ec-store/category-page', {
    ...
    edit: function (props) {
        ...
        const editor =
            <EcwidProductBrowserBlock props={props} attributes={attributes} icon={EcwidIcons.category} title={__('Store Category Page', 'ecwid-shopping-cart')} showDemoButton={blockParams.isDemoStore}>
                ...
                <div className="ec-store-products">
                    <div className="ec-store-product-block">
                        <div className="ec-store-product ec-store-category-hat"></div>
                    </div>
                    <div className="ec-store-product-block">
                        <div className="ec-store-product ec-store-category-watch"></div>
                    </div>
                    <div className="ec-store-product-block">
                        <div className="ec-store-product ec-store-category-glasses"></div>
                    </div>
                </div>

						...
						<div class="a-card a-card--normal">
							<div class="a-card__paddings">
								<div class="smart-row">
									<div class="smart-row__column">
										<div class="titled-value">
											<div class="titled-value__title"><?php _e('Ecwid Categories', 'ecwid-shopping-cart');?></div>
											<div class="titled-value__value"><?php echo Ecwid_Importer::count_ecwid_categories();?></div>
										</div>
									</div>
									<div class="smart-row__column">
										<div class="titled-value">
											<div class="titled-value__title"><?php _e('Ecwid Products', 'ecwid-shopping-cart');?></div>
									...
									<div class="smart-row__column">
										<div class="titled-value">
											<div class="titled-value__title">
												<?php
												echo sprintf(
													__( '%s Categories after import', 'ecwid-shopping-cart' ),
													Ecwid_Config::get_brand()
												);?>
											</div>
											<div class="titled-value__value">
												<?php echo Ecwid_Importer::count_ecwid_categories() + Ecwid_Importer::count_woo_categories();?>
											</div>
										</div>
									</div>
									<div class="smart-row__column">
										<div class="titled-value">
											<div class="titled-value__title">
												<?php
												echo sprintf(
													__( '%s Products after import', 'ecwid-shopping-cart' ),
													Ecwid_Config::get_brand()
												);?>
											</div>
											<div class="titled-value__value">
												<?php echo Ecwid_Importer::count_ecwid_products() + Ecwid_Importer::count_woo_products();?>
											</div>
										</div>
									</div>
								</div>
